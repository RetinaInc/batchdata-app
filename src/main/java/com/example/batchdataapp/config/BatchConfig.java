...
public class BatchConfig {
    ...
    CommandLineRunner runner(JobLauncher launcher,
        ...
        return args -> {
            ...
            System.out.println("Execution Status from Batch Config: "+execution.getExitStatus().toString());
...
//            jdbcTemplate.query("select * from PEOPLE", new RowMapper<Person>() {
//                @Override
//                public Person mapRow(ResultSet rs, int rowNum) throws SQLException {
//
//                    return new Person(rs.getString("first"),
//                            rs.getString("last"),
//                            rs.getString("email")
//                            );
//                }
